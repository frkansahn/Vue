	...
	var // jQuery and jQueryUI version
		...
		opts = {
			bootCallback : function(fm) {
				// for TinyMCE 5
				var wmng = parent.tinymce.activeEditor.windowManager;
				if (wmng._elfinderCallBack) {
					fm._tinymceCallback = wmng._elfinderCallBack;
					delete wmng._elfinderCallBack;
				}
			},
			getFileCallback : function(file, fm) {
				...
				if (windowManager != '') {
					top.window.fileCallback(file,fm);
					windowManager.close();
				}
			},
